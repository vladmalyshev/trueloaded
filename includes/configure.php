...
// define our database connection
  ...
  define('DB_DATABASE', 'trueloadeduk');
...
// make a connection to the database... now
  ...
  if ($platform['platform_id'] > 0) {
    ...
    define('HTTP_COOKIE_DOMAIN', $parsed['host']);
    define('HTTPS_COOKIE_DOMAIN', $parsed_ssl['host']);
    ...
    define('HTTP_SERVER', 'http://tl.local');
    define('HTTPS_SERVER', 'https://tl.local');
