...
class xtrader extends ModuleDropShipping {
    ...
    private function analyzeResponse($response, $order){
        ...
        if ($send_mail){
            ...
            $email_params['ORDER_NUMBER'] = $order->orders_id;
    ...
    public function extra_params() {
        ...
        for ($i = 0, $n = sizeof($directory_array); $i < $n; $i++) {
            ...
            if (file_exists(DIR_FS_CATALOG_LANGUAGES . 'modules/shipping/' . $file)) {
                require_once(DIR_FS_CATALOG_LANGUAGES . 'modules/shipping/' . $file);
            }
