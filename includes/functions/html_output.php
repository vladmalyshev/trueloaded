...
// Outputs a button in the selected language
  function tep_image_submit($image, $alt = '', $parameters = '') {
    ...
    $image_submit = '<input type="image" src="' . \common\helpers\Output::output_string(DIR_WS_LANGUAGES . $language . '/images/buttons/' . $image) . '" border="0" alt="' . \common\helpers\Output::output_string($alt) . '"';

    if (tep_not_null($alt)) $image_submit .= ' title=" ' . \common\helpers\Output::output_string($alt) . ' "';
