...
<?php if (ACCOUNT_COMPANY_VAT_ID == 'true' && \common\helpers\Customer::check_customer_groups($group, 'groups_is_reseller')) echo '  check_input("entry_company_vat", ' . ENTRY_VAT_ID_MIN_LENGTH . ', "' . ENTRY_VAT_ID_ERROR . '");' . "\n"; ?>
