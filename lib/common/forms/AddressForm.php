...
class AddressForm extends Model {    
    ...
    public function rules() {
        return [
            [['address_book_id', 'company', 'company_vat', 'gender', 'firstname', 'lastname', 'telephone', 'postcode', 'street_address', 'suburb', 'city', 'state', 'country', 'zone_id'], 'stronglyRequired', 'skipOnEmpty' => false],
    ...
    public function has($postfix, $includeVisible = true){
        if ($includeVisible){
            if ($_c = $this->up($postfix)){
                return in_array($_c, ['required', 'required_register', 'visible', 'visible_register']);
            }
        } else {
            if ($_c = $this->up($postfix)){
                return in_array($_c, ['required', 'required_register']);
            }
        }   
        return false;
    }
