...
abstract class OrderShadowAbstract implements OrderInterface {
    ...
    public function prepareOrderInfo() {
        ...
        $this->info = [
            ...
            'shipping_cost_inc_tax' => @$shipping['cost_inc_tax'],
    ...
    public function prepareProducts() {
        ...
        for ($i = 0, $n = sizeof($products); $i < $n; $i++) {
            ...
            $this->products[$index] = array('qty' => $products[$i]['quantity'],
                ...
                'parent_product' => $products[$i]['parent'],
                'sub_products' => $products[$i]['sub_products'],
...
// {{ Bonus Points
                'bonus_points_price' => $products[$i]['bonus_points_price'],
                'bonus_points_cost' => $products[$i]['bonus_points_cost'],
// }}                
...
// }}
    ...
    public function _setAddress($address) {
        ...
        return array(
            ...
            'telephone' => $address['entry_telephone'] == '' ? $this->customer['telephone'] : $address['entry_telephone'],
    ...
    public function prepareOrderAddresses() {
        ...
        if ($this->manager->isCustomerAssigned()) {
            ...
            if (is_array($this->manager->get('sendto'))) {
                ...
                if ($this->delivery['country_iso_code_2']) {
            ...
            if (is_array($this->manager->get('billto'))) {
                ...
                if ($this->billing['country_iso_code_2']) {
    ...
    function getTaxValues($tax_class_id) {
        ...
        if ($delivery_tax_values['tax'] > 0) {
            ...
            return \common\helpers\Tax::getTaxValues($this->info['platform_id'], $tax_class_id, Address::extractCountryId($check_billing), $check_billing['zone_id']);
        }
