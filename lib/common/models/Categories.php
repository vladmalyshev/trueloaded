...
class Categories extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['categories_seo_page_name', 'categories_old_seo_page_name', 'google_product_category'], 'string', 'max' => 255],
        ];
    }
 ...
 */
    ...
    public static function isVisible($categoryId) {
      ...
      if ($c) {
        ...
        if (is_array($p) && $p[0]['parents_id'] == 0 && $c->categories_level == count($p)+1) {
          $ret=true;
        }
      }
      return $ret;
