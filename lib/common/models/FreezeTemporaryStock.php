 ...
 */
class FreezeTemporaryStock extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['warehouse_id', 'suppliers_id', 'location_id', 'customers_id', 'prid', 'parent_id', 'temporary_stock_quantity', 'not_available_quantity'], 'integer'],
