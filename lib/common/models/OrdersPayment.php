...
class OrdersPayment extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['orders_payment_id_parent', 'orders_payment_order_id', 'orders_payment_is_credit', 'orders_payment_status', 'orders_payment_admin_create', 'orders_payment_admin_update'], 'integer'],
            [['orders_payment_order_id', 'orders_payment_module', 'orders_payment_module_name', 'orders_payment_amount', 'orders_payment_snapshot'], 'required'],
            [['orders_payment_amount', 'orders_payment_currency_rate'], 'number'],
            [['orders_payment_snapshot', 'orders_payment_transaction_commentary'], 'string'],
            [['orders_payment_transaction_date', 'orders_payment_date_create', 'orders_payment_date_update'], 'safe'],
