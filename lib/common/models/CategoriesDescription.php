...
class CategoriesDescription extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['categories_id', 'language_id', 'categories_name', 'categories_head_title_tag', 'categories_head_desc_tag', 'categories_head_keywords_tag', 'affiliate_id', 'categories_seo_page_name', 'google_product_category', 'noindex_option', 'nofollow_option', 'rel_canonical', 'categories_h1_tag', 'categories_h2_tag', 'categories_h3_tag', 'categories_image_alt_tag_mask', 'categories_image_title_tag_mask'], 'required'],
            ...
            [['categories_seo_page_name', 'google_product_category', 'categories_h1_tag', 'categories_image_alt_tag_mask', 'categories_image_title_tag_mask'], 'string', 'max' => 255],
