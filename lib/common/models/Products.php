 ...
 * @property int $google_product_type
...
{
  public static $listingDescriptionFields = ['products_name', 'products_description', 'products_url', 'products_head_title_tag', 'products_description_short', 'products_seo_page_name', 'products_h1_tag', 'products_h2_tag', 'products_h3_tag' ];
  ...
  /**
    ...
    public function rules()
    {
        return [
            ...
            [['products_date_added', 'products_last_modified', 'products_date_available', 'last_xml_import', 'last_xml_export'], 'safe'],
            [['products_model', 'products_seo_page_name', 'products_old_seo_page_name', 'products_file', 'products_price_discount', 'google_product_category', 'products_price_discount_pack_unit', 'products_price_discount_packaging'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'google_product_type' => 'Google Product Type',
    ...
    public function getDescription()
    {
        ...
        return $this->hasOne(ProductsDescription::class, ['products_id' => 'products_id'])
                ->where(['language_id' => (int)$languages_id, 'platform_id' => \common\classes\platform::currentId()]);
    }
...
//
    ...
    {
        return $this->hasMany(GapiSearch::class, ['gapi_id' => 'gapi_id'])
            ->viaTable(GapiSearchToProducts::tableName(), ['products_id' => 'products_id'])
            ;
    }
