...
*/
    ...
    {
        if ( $ext = \common\helpers\Acl::checkExtension('AutomaticallyStatus', 'allowed') && isset($this->auto_status) ) {
    ...
    public function afterSave($insert, $changedAttributes)
    {
        ...
        if ( isset($this->auto_status) && $ext = \common\helpers\Acl::checkExtension('AutomaticallyStatus', 'allowed') ) {
