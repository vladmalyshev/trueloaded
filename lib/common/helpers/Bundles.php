            ...
            while ($products_options_name = tep_db_fetch_array($products_options_name_query)) {
                ...
                while ($products_options = tep_db_fetch_array($products_options_query)) {
                    ...
                    $check_inventory = tep_db_fetch_array(tep_db_query(
                      "select inventory_id, max(products_quantity) as products_quantity, products_id, stock_indication_id, stock_delivery_terms_id ".
...
//vl2do - id is 0 - details are diff
          ...
          $check_parent = tep_db_fetch_array(tep_db_query("select use_sets_discount from " . TABLE_PRODUCTS . " where products_id = '" . (int) \common\helpers\Inventory::get_prid($mainUprid) . "'"));
