...
class Categories {
    ...
    public static function set_categories_status($category_id, $status) {
        ...
        if ($ext = \common\helpers\Acl::checkExtension('AutomaticallyStatus', 'categoryAutoSwitchOff')) {
 ...
 */
    ...
    public static function load_tree_slice($platform_id, $category_id, $activeProducts = false, $search = '', $inner = false, $innerCategory = false, $activeCategories = false){
          ...
          $get_products_r = tep_db_query(
            "SELECT concat('p',p.products_id,'_',p2c.categories_id) AS `key`, ".ProductNameDecorator::instance()->listingQueryExpression('pd','pd1')." as title, ".
 ...
 */
    ...
    /**
     * not used yet ... transform plain array to tree
