...
class OrderProduct
{
    ...
    public static function doAllocateAutomatic($orderProductRecord = 0, $doCache = false)
    {
        ...
        if (defined('ENABLE_FREEZE_STOCK') && ENABLE_FREEZE_STOCK == '1') {
            self::doAllocateAutomaticWarehouseFreeze($orderProductRecord, $orderRecord, $productRecord);
    ...
    private static function doAllocateAutomaticWarehouseFreeze(\common\models\OrdersProducts $orderProductRecord, \common\models\Orders $orderRecord, \common\models\Products $productRecord)
    {
        ...
        $stockReceived = $orderProductRecord->products_quantity;//how many products you can recieve

        $orderProductAllocateRecord = new \common\models\FreezeOrdersProductsAllocate();
        try {
            ...
            $orderProductAllocateRecord->suppliers_price = 0;
    ...
    public static function getStockOrdered($orderProductRecord = 0)
    {
        ...
        if ($orderProductRecord instanceof \common\models\OrdersProducts) {
            foreach (\common\models\PurchaseOrdersProducts::find()
                ...
                ->where(['OR', ['uprid' => $orderProductRecord->uprid], ['uprid' => \common\helpers\Inventory::getInventoryId($orderProductRecord->uprid)]])
