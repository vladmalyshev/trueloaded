...
class ModuleProvider extends Providers {
    ...
    private static $modules = ['analytics', 'adwords', 'ecommerce', 'verification', 'tagmanger', 'reviews', 'klaviyo_analytics', 'klaviyo_ecommerce'];
    ...
    public function getInstalledModules($platform_id, $console = false) {
        ...
        if (is_array($modules)) {
            foreach ($modules as $mod) {
                $mods[$mod['module']] = $this->_describeSetting($mod, true);
            }
        }
