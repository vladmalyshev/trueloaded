...
class GoogleTools 
{
    ...
    public function getModulesProvider(){
        if (!is_object($this->provider['ModulesProvider'])) {
    ...
    public function getMapProvider(){
        if (!is_object($this->provider['MapProvider'])) {
    ...
    public function getCaptchaProvider(){
        if (!is_object($this->provider['CaptchaProvider'])) {
    ...
    public function getAnalyticsProvider(){
        if (!is_object($this->provider['AnalyticsProvider'])) {
