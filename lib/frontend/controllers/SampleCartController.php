...
/**
 * sample-cart controller
 */
class SampleCartController extends Sceleton {

    public function actionIndex() {
        global $sample, $breadcrumb;
        ...
        $breadcrumb->add(NAVBAR_TITLE, tep_href_link('sample-cart'));
        ...
        $render_data = array(
            'action' => tep_href_link('sample-cart', 'action=update_sample'),
