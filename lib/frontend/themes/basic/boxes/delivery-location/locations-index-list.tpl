        ...
        {foreach $locations_list as $location}
            <li>
                {if $location['image_listing_src']}
                    <div class="deliveryImg"><a href="{$location['href']}" title="{$location['title']|escape:'html'}"><img src="{$location['image_listing_src']}" border="0" width="{$location['image_listing_width']}" height="{$location['image_listing_height']}" alt="{$location['title']|escape:'html'}"></a></div>
                {/if}
