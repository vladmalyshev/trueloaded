...
<h2 class="bundle_title">{$smarty.const.TEXT_BUNDLE_PRODUCTS_NEW}</h2>
  ...
  {/foreach}
  <div class="bundle-total-price">{$smarty.const.TEXT_TOTAL_PRICE} <div class="price"><span id="full-bundle-price" class="old"></span><span id="actual-bundle-price" class="specials"></span></div></div>
</div>
