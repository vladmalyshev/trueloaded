...
<div class="qty-input"{if $product_in_cart} style="display: none"{/if}>
  ...
  <div class="input inps">
        ...
        <input type="text" name="qty_[2]" value="0" class="qty-inp"  data-type="packaging" data-min="0" {if $quantity_max>0} data-max="{floor($quantity_max/$product.packaging)}"{/if} >
...
<div class="qty-input"{if !$show_quantity_input && SHOW_QUANTITY_INPUT_FOR_QUOTE_BUTTON != 'True' || $product_in_cart} style="display: none"{/if}>
