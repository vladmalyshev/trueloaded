...
{if $settings[0].orders_data == 'name'}
    ...
    <div class="orders-data orders-data-name">{$order_customer.name}</div>

{elseif $settings[0].orders_data == 'email'}

    <div class="orders-data orders-data-email">{$order_customer.email_address}</div>

{elseif $settings[0].orders_data == 'telephone'}

    {if $order_customer.telephone}
        <div class="orders-data orders-data-telephone">{$order_customer.telephone}</div>
    {else}
        {$empty = true}
    {/if}
