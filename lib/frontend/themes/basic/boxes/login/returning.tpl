...
<div class="login-box">
    ...
    <div class="middle-form">
        ...
        {if $b2b = \common\helpers\Acl::checkExtension('BusinessToBusiness', 'check')}
        ...
        <div class="col-left">
            ...
            {Html::activeInput('text', $loginModel, 'email_address')}
        </div>
        <div class="col-right">
            <label for="password1">{field_label const="PASSWORD" required_text=""}</label>
            {Html::activePasswordInput($loginModel, 'password', ['autocomplete' => "off"])}
        </div>
...
<script>
    function checkTerms(form) {
        {if $b2b = \common\helpers\Acl::checkExtension('BusinessToBusiness', 'checkNeedLogin')}
            {if $b2b::checkNeedLogin()}
