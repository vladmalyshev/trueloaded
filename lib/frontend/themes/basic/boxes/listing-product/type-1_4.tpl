...
{else}
    {$can_buy = false}
{/if}
{if ((!Yii::$app->user->isGuest) || $settings[0].list_demo) && !GROUPS_DISABLE_CHECKOUT}
    {$can_save = true}
{else}
    {$can_save = false}
{/if}
