    ...
    <div class="estimate-shipping form-inputs">
        ...
        <label>
          ...
          <select name="estimate[country_id]">
            {foreach $countries as $country}
              <option value="{$country.countries_id}"{if $country.countries_id == $estimate['country_id']} selected{/if}>{$country.countries_name}</option>
            {/foreach}
          </select>
        </label>
      </div>
      <div class="col-left">
        <label>
          ...
          <input type="text" name="estimate[post_code]" value="{$estimate['postcode']|escape:'html'}"/>
        </label>
      </div>
      <div class="col-right">
