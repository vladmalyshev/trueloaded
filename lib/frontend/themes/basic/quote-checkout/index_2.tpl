...
<div class="multi-page-checkout">
        ...
        <div class="checkout-step active" id="shipping-step">
            <div class="checkout-heading">
                ...
                {Block::widget(['name' => 'checkout_delivery_title'|cat:$noShipping|cat:'_g', 'params' => ['type' => 'checkout', 'params' => $params]])}
            </div>
            <div class="checkout-content">

                {Block::widget(['name' => 'checkout_delivery'|cat:$noShipping|cat:'_g', 'params' => ['type' => 'checkout', 'params' => $params]])}
        ...
        <div class="checkout-step" id="payment-step">
            <div class="checkout-heading">
                ...
                {Block::widget(['name' => 'checkout_payment_title'|cat:$noShipping|cat:'_g', 'params' => ['type' => 'checkout', 'params' => $params]])}
            </div>
            <div class="checkout-content" style="display: none">

                {Block::widget(['name' => 'checkout_payment'|cat:$noShipping|cat:'_g', 'params' => ['type' => 'checkout', 'params' => $params]])}
        ...
        <div class="checkout-step" id="confirmation-step">
            <div class="checkout-heading"><span class="count">3</span>
                {Block::widget(['name' => 'checkout_confirmation_title'|cat:$noShipping|cat:'_g', 'params' => ['type' => 'confirmation', 'params' => $params]])}
            </div>
            <div class="checkout-content" style="display: none"></div>
        </div>

        <div class="checkout-products">
            {Block::widget(['name' => 'checkout_step_bottom'|cat:$noShipping|cat:'_g', 'params' => ['type' => 'checkout', 'params' => $params]])}
        </div>
...
<script type="text/javascript">
    ...
    tl([
        ...
        $('body').on('click', '#shipping-step .btn-2', function(e){
            e.preventDefault();
        ...
        $('body').on('click', '#payment-step .btn-2', function(e){
            e.preventDefault();
