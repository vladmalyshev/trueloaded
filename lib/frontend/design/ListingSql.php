...
class ListingSql
{
  ...
  public static function get_listing_sql_array($filename = '') {
    ...
    case 'catalog/featured-products': // show featured products
      ...
      if (tep_session_is_registered('affiliate_ref') && $_SESSION['affiliate_ref'] != '') {
        $listing_where .= " and (f.affiliate_id = '" . (int)$_SESSION['affiliate_ref'] . "' or f.affiliate_id = 0) ";
      } else {
  ...
  public static function get_filters_sql_array($exclude = '') {
    ...
    if (isset($_GET['keywords'])) {
        ...
        $_GET['keywords'] = (string)$_GET['keywords'];
        ...
        if (isset($relevance_keywords) && (sizeof($relevance_keywords) > 0)) {
            if (defined('SHOW_GOOGLE_KEYWORD_PRODUCTS') && SHOW_GOOGLE_KEYWORD_PRODUCTS == 'True'){
                $filters_left_join .= " left join gapi_search_to_products gsp on p.products_id = gsp.products_id left join gapi_search gs on gsp.gapi_id = gs.gapi_id ";
            }
            ...
            if (defined('SHOW_GOOGLE_KEYWORD_PRODUCTS') && SHOW_GOOGLE_KEYWORD_PRODUCTS == 'True'){
                $relevance_order .= " + (match(gs.gapi_keyword) against ('" . implode(' ', $relevance_keywords) . "') * 1.5) ";
            }
