    ...
    public function run()
    {
        ...
        if ($promotions){
            ...
            foreach($promotions as $pIdx=> &$promo){
                if (is_array($promo->sets) && count($promo->sets) && PromotionService::isPersonalizedPromoToCustomer($promo->promo_id)){
 ...
 */
        ...
        $collection_products = \common\helpers\Collections::obtainCollectionProducts($params, $products, $all_filled_array, $stock_indicators_ids, $stock_indicators_array, $collection_base_price, $collection_full_price, $stock_indicator_public);
