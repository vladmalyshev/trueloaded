...
class Tax_classesController extends Sceleton  {
    ...
    public function actionIndex() {
      ...
      $this->topButtons[] = '<a href="#" class="create_item" onclick="return taxEdit(0)">'.TEXT_INFO_HEADING_NEW_TAX_CLASS.'</a>';
	...
	public function actionEdit(){
	  ...
	  if($tax_classes_id){
		...
		echo tep_draw_form('classes', FILENAME_TAX_CLASSES, 'page=' . $_GET['page'] . '&tID=' . $tcInfo->tax_class_id . '&action=save');
		echo '<div class="row_or_wrapp">';
                echo '<div class="main_row"><div class="main_title">' . TEXT_INFO_CLASS_TITLE . '</div><div class="main_value">' . tep_draw_input_field('tax_class_title', $tcInfo->tax_class_title, 'class="form-control"') . '</div></div>';
                echo '<div class="main_row"><div class="main_title">' . TEXT_INFO_CLASS_DESCRIPTION . '</div><div class="main_value">' . tep_draw_input_field('tax_class_description', $tcInfo->tax_class_description, 'class="form-control"') . '</div></div>';
                echo '</div>';
		echo '<div class="btn-toolbar btn-toolbar-order">';
