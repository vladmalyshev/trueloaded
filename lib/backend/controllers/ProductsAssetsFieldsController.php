...
class ProductsAssetsFieldsController extends Sceleton {
    ...
    public function actionStatusactions() {
        ...
        if ($ext = \common\helpers\Acl::checkExtension('ProductAssets', 'adminStatusactionsAssets')) {
    ...
    public function actionEdit() {
        ...
        if ($ext = \common\helpers\Acl::checkExtension('ProductAssets', 'adminEditAssets')) {
            echo $ext::adminEditAssets();
        }
    }

    public function actionSave() {
        if ($ext = \common\helpers\Acl::checkExtension('ProductAssets', 'adminSaveAssets')) {
    ...
    public function actionConfirmdelete() {
        ...
        if ($ext = \common\helpers\Acl::checkExtension('ProductAssets', 'adminConfirmdeleteAssets')) {
            echo $ext::adminConfirmdeleteAssets();
        }
    }

    public function actionDelete() {
        if ($ext = \common\helpers\Acl::checkExtension('ProductAssets', 'adminDeleteAssets')) {
