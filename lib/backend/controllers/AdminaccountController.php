...
class AdminaccountController extends Sceleton
{
    ...
    public function __construct($id, $module=null, AdminRepository $adminRepository, array $config = []){
    ...
    function actionSelectPosPlatformForm() {
        ...
        return $this->renderPartial('pos-platform-form.tpl',[
            'myAccount' => $myAccount,
            'platformDropDown' => (['0' => TEXT_ALL]+ArrayHelper::map($aPlatforms,'platform_id','platform_name')),
