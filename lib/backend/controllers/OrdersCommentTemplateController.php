...
class OrdersCommentTemplateController extends Sceleton  {
    ...
    public function actionIndex() {
        ...
        $this->topButtons[] = '<a href="'.Url::to(['orders-comment-template/edit']).'" class="create_item">'.TEXT_BTN_NEW_ORDERS_COMMENT_TEMPLATE.'</a>';
    ...
    public function actionEdit() {
        ...
        $this->navigation[] = array(
            ...
            'title' => ($model->isNewRecord? TEXT_HEADING_NEW_ORDERS_COMMENT_TEMPLATE:TEXT_HEADING_EDIT_ORDERS_COMMENT_TEMPLATE.' "'.$description->name.'"')
        );
