...
class VirtualGiftCardController extends Sceleton {
    ...
    public function actionIndex() {
        ...
        $platforms = \common\models\Platforms::getPlatformsByType("non-virtual")->orderBy("is_marketplace, sort_order")->all();
    ...
    public function actionSubmit() {
        ...
        $platforms = \common\models\Platforms::getPlatformsByType("non-virtual")->orderBy("is_marketplace, platform_name")->all();
        $languages = \common\helpers\Language::get_languages();
