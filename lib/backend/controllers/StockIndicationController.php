...
class StockIndicationController extends Sceleton  {
  ...
  public function actionIndex() {
    ...
    public function actionEdit() {
      ...
      /**/echo '<div class="check_linear"><label><span>' . TEXT_STOCK_CODE_TYPE . '</span> ' . tep_draw_pull_down_menu('stock_code',array(
...
/**/
      ...
      if ($extClass = \common\helpers\Acl::checkExtensionAllowed('ObsoleteProducts', 'allowed')) {
        echo '<div class="check_linear"><label>' . tep_draw_checkbox_field('is_obsolete',1, !!$oInfo->is_obsolete) . '<span>' . TEXT_IS_OBSOLETE . '</span></label></div>';
      }
      echo '<div class="check_linear"><label>' . tep_draw_radio_field('display_price_options',0, ($oInfo->display_price_options==0)) . '<span>' . TEXT_STOCK_INTICATION_PRICE_ON . '</span></label></div>';
      echo '<div class="check_linear"><label>' . tep_draw_radio_field('display_price_options',1, ($oInfo->display_price_options==1)) . '<span>' . TEXT_STOCK_INTICATION_PRICE_OFF . '</span></label></div>';
      echo '<div class="check_linear"><label>' . tep_draw_radio_field('display_price_options',2, ($oInfo->display_price_options==2)) . '<span>' . TEXT_STOCK_INTICATION_PRICE_ZERO . '</span></label></div>';
      echo '<div class="check_linear"><label>' . tep_draw_radio_field('display_virtual_options',0, ($oInfo->display_virtual_options==0)) . '<span>' . TEXT_STOCK_INTICATION_VIRTUAL_INC . '</span></label></div>';
      echo '<div class="check_linear"><label>' . tep_draw_radio_field('display_virtual_options',1, ($oInfo->display_virtual_options==1)) . '<span>' . TEXT_STOCK_INTICATION_VIRTUAL_ON . '</span></label></div>';
      echo '<div class="check_linear"><label>' . tep_draw_radio_field('display_virtual_options',2, ($oInfo->display_virtual_options==2)) . '<span>' . TEXT_STOCK_INTICATION_VIRTUAL_OFF . '</span></label></div>';
