...
<div class="row_or_img"><?php echo  \common\helpers\Image::info_image($rInfo_array['products_image'], $rInfo_array['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT); ?></div>
    ...
    public function actionEdit()
    {
        ...
        $image = (file_exists(DIR_FS_CATALOG_IMAGES . $products['products_image']) ? '<span class="prodImgC">' . \common\helpers\Image::info_image($products['products_image'], $products['products_name'], 50, 50) . '</span>' : '<span class="cubic"></span>');
//        echo tep_draw_form(
//                'save_item_form',
//                'reviews/index',
