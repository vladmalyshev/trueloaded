...
class Orders_status_groupsController extends Sceleton {
    ...
    public function actionIndex() {
        ...
        $this->view->filterStatusTypes = \yii\helpers\Html::dropDownList('ostID', (int)$_GET['ostID'], \common\helpers\Status::getStatusTypeList(true), ['class'=>'form-control', 'onchange' => 'return applyFilter();']);
    ...
    public function actionEdit() {
        ...
        echo '<div class="main_row"><div class="main_title">' . TEXT_INFO_ORDERS_STATUS_GROUPS_STORE_TEMPORARY . '</div><div class="main_value">' . \yii\helpers\Html::checkbox('orders_status_groups_store_temporary', $oInfo->orders_status_groups_store_temporary) . '</div></div>';
        echo '<div class="main_row"><div class="main_title">' . TEXT_INFO_ORDERS_STATUS_GROUPS_SEND_GA . '</div><div class="main_value">' . \yii\helpers\Html::checkbox('orders_status_groups_send_ga', $oInfo->orders_status_groups_send_ga) . '</div></div>';
        echo '<div class="btn-toolbar btn-toolbar-order">';
