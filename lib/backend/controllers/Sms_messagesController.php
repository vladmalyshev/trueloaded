...
class Sms_messagesController extends Sceleton {
    ...
    {
        if (false === \common\helpers\Acl::checkExtension('SMS', 'allowed')) {
            $this->redirect(array('/'));
            return false;
        }
    ...
    public function actionIndex() {
        ...
        $this->topButtons[] = '<a href="javascript:void(0)" onClick="newMessage();" class="create_item"><i class="icon-file-text"></i>' . IMAGE_INSERT . '</a>';
