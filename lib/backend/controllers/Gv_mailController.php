...
class Gv_mailController extends Sceleton {
    ...
    public function __construct($id, $module = null, CustomersService $customersService, array $config = [])
    {
    ...
    public function actionIndex() {
        ...
        $customers = array();
        $customer = urldecode(($_GET['customer']?$_GET['customer']:$_GET['mail_sent_to']));
 ...
 */
    ...
    public function actionCustomerSearch(string $term = null)
    {
        ...
        $predict = [
            ...
            ['id' => '**D', 'value' => TEXT_NEWSLETTER_CUSTOMERS],
        ];
    ...
    public function actionSendemailtouser() {
        ...
        if ($_POST['customers_email_address'] && !$_POST['back_x']) {
            ...
            if (($_POST['customers_email_address'] == '***' || $_POST['customers_email_address'] == '**D') &&
                \common\helpers\Validations::validate_email($_POST['customers_email_address_field'])) {
                $_POST['customers_email_address'] = $_POST['customers_email_address_field'];
            }
            ...
            switch ($_POST['customers_email_address']) {
                case '***':
                    ...
                    break;
                case '**D':
                    $mail_query = tep_db_query("select customers_firstname, customers_lastname, customers_email_address, customers_id, platform_id, language_id from " . TABLE_CUSTOMERS . " where customers_newsletter = '1'");
                    $mail_sent_to = TEXT_NEWSLETTER_CUSTOMERS;
                    break;
                default:
            ...
            if (!$error ){
                ...
                if (tep_db_num_rows($mail_query)){
                    while ($mail = tep_db_fetch_array($mail_query)) {
                        ...
                        $data = \common\helpers\Coupon::generate_customer_gvcc($coupon_id, $mail['customers_email_address'], $_POST['amount'], $platforms[$mail['platform_id']], $mail['customers_id']);
