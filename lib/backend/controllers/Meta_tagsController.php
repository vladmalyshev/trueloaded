...
//        $data[$key1][$key2] = $get_ex_values['meta_tags_value'];
    ...
    $tabs_data = array(
      ...
      'CATEGORY_CONTACT_US_TAGS' => array(
        'tab_title' => CATEGORY_CONTACT_US_TAGS,
        'id' => 'contact_us_tags',
        'input_key' => array(
          'HEAD_TITLE_TAG_CONTACT_US', 'HEAD_KEY_TAG_CONTACT_US', 'HEAD_DESC_TAG_CONTACT_US', 'HEAD_H1_TAG_CONTACT_US', 'HEAD_H2_TAG_CONTACT_US', 'HEAD_H3_TAG_CONTACT_US',
        ),
      ),
      ...
      'CATEGORY_DELIVERY_LOCATION_TAGS' => array(
        'tab_title' => CATEGORY_DELIVERY_LOCATION_TAGS,
        'class' => 'add-keys',
        'popupOption' => 'delivery-location',
        'id' => 'delivery_location_tags',
        'input_key' => array(
          'HEAD_TITLE_TAG_DELIVERY_LOCATION', 'HEAD_KEY_TAG_DELIVERY_LOCATION', 'HEAD_DESC_TAG_DELIVERY_LOCATION', 'DEFAULT_BREADCRUMB_DELIVERY_LOCATION', 'HEAD_H1_TAG_DELIVERY_LOCATION', 'HEAD_H2_TAG_DELIVERY_LOCATION', 'HEAD_H3_TAG_DELIVERY_LOCATION',
        ),
      ),
