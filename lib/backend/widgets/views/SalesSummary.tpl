...
<div class="gridBg">
  <div class="summary-wrapper">
      <div class="summary-title">{$smarty.const.TEXT_SALES_SUMMARY}<form action="{$app->urlManager->createUrl('orders/process-order')}" method="get" class="go-to-order">{$smarty.const.TEXT_GO_TO_ORDER} <input type="text" class="form-control" name="orders_id"/> <button type="submit" class="btn btn-primary">{$smarty.const.TEXT_GO}</button></form>
      ...
      <div class="summary-box-wrapper after">
          <div class="dashw dashw-1 after">
              <div class="summary-box summary-box-info">
                <div class="sbv">
                    <div class="sb-title">{$smarty.const.TEXT_PRODUCTS}</div>
                    <div class="dash-orders dash-list">
                    ...
                    <div class="dash-orders dash-child">
                    ...
                    {if $TrustpilotClass = Acl::checkExtension('Trustpilot', 'enabledDashboard')}
                            {if $TrustpilotClass::enabledDashboard()}
                                 {$TrustpilotClass::viewDashboard()}
                            {else}
                            <div class="dash-orders dash-review">
            ...
            <div class="summary-box summary-box-today">
              <div class="sbv">
                ...
                <a class="sb-line sb-line-01" href="{$app->urlManager->createUrl('customers?date=presel&interval=1')}"><span>{$stats.today.customers}</span>{$smarty.const.TEXT_CLIENTS}</a>
                <div class="dash-orders">
                    <div class="dash-orders-title">{$smarty.const.TEXT_ORDERS}</div>
                    <div class="dash-orders-sub-title after">
                        <div><a href="{$app->urlManager->createUrl('orders?interval=1&fs=open')}"><span>{$stats.today.orders_new}</span>{$smarty.const.TEXT_NOT_PROCESSED_ORDERS_DASHBOARD}</a></div>
                        <div><a href="{$app->urlManager->createUrl('orders?interval=1&fs=open')}"><span>{$stats.today.orders}</span>{$smarty.const.TEXT_ALL}</a></div>                        
                    </div>
                </div>
                <div class="sb-line sb-line-04"><i>{$smarty.const.TEXT_AVERAGE_ORDER_VALUE}</i><span>{$stats.today.orders_avg_amount}</span></div>
                <div class="sb-line sb-line-05 global-currency {$prefix}">{$smarty.const.TEXT_AMOUNT}<span>{$stats.today.orders_amount}</span></div>
          ...
          <div class="summary-box summary-box-week">
              <div class="sbv">
                  ...
                  <a class="sb-line sb-line-01" href="{$app->urlManager->createUrl('customers?date=presel&interval=week')}">{$smarty.const.TEXT_CLIENTS}<span>{$stats.week.customers}</span></a>
                  <div class="dash-orders">
                    <div class="dash-orders-title">{$smarty.const.TEXT_ORDERS}</div>
                    <div class="dash-orders-sub-title after">
                        <div><a href="{$app->urlManager->createUrl('orders?interval=week&fs=open')}"><span>{$stats.week.orders_not_processed}</span>{$smarty.const.TEXT_NOT_PROCESSED_ORDERS_DASHBOARD}</a></div>
                        <div><a href="{$app->urlManager->createUrl('orders?interval=week&fs=open')}"><span>{$stats.week.orders}</span>{$smarty.const.TEXT_ALL}</a></div>
                    </div>
                </div>
                  <div class="sb-line sb-line-04"><i>{$smarty.const.TEXT_AVERAGE_ORDER_VALUE}</i><span>{$stats.week.orders_avg_amount}</span></div>
                  <div class="sb-line sb-line-05 global-currency {$prefix}">{$smarty.const.TEXT_AMOUNT}<span>{$stats.week.orders_amount}</span></div>
              ...
              <div class="sbv">
                  ...
                  <a class="sb-line sb-line-01" href="{$app->urlManager->createUrl('customers?date=presel&interval=month')}">{$smarty.const.TEXT_CLIENTS}<span>{$stats.month.customers}</span></a>
                  <div class="dash-orders">
                    <div class="dash-orders-title">{$smarty.const.TEXT_ORDERS}</div>
                    <div class="dash-orders-sub-title after">
                        <div><a href="{$app->urlManager->createUrl('orders?interval=month&fs=open')}"><span>{$stats.month.orders_not_processed}</span>{$smarty.const.TEXT_NOT_PROCESSED_ORDERS_DASHBOARD}</a></div>
                        <div><a href="{$app->urlManager->createUrl('orders?interval=month&fs=open')}"><span>{$stats.month.orders}</span>{$smarty.const.TEXT_ALL}</a></div>                        
                    </div>
                </div>
                  <div class="sb-line sb-line-04"><i>{$smarty.const.TEXT_AVERAGE_ORDER_VALUE}</i><span>{$stats.month.orders_avg_amount}</span></div>
                  <div class="sb-line sb-line-05 global-currency {$prefix}">{$smarty.const.TEXT_AMOUNT}<span>{$stats.month.orders_amount}</span></div>
          ...
          <div class="summary-box summary-box-year">
              <div class="sbv">
                  ...
                  <a class="sb-line sb-line-01" href="{$app->urlManager->createUrl('customers?date=presel&interval=year')}">{$smarty.const.TEXT_CLIENTS}<span>{$stats.year.customers}</span></a>
                  <div class="dash-orders">
                    <div class="dash-orders-title">{$smarty.const.TEXT_ORDERS}</div>
                    <div class="dash-orders-sub-title after">
                        <div><a href="{$app->urlManager->createUrl('orders?interval=year&fs=open')}"><span>{$stats.year.orders_not_processed}</span>{$smarty.const.TEXT_NOT_PROCESSED_ORDERS_DASHBOARD}</a></div>
                        <div><a href="{$app->urlManager->createUrl('orders?interval=year&fs=open')}"><span>{$stats.year.orders}</span>{$smarty.const.TEXT_ALL}</a></div>
                    </div>
                </div>
                  <div class="sb-line sb-line-04"><i>{$smarty.const.TEXT_AVERAGE_ORDER_VALUE}</i><span>{$stats.year.orders_avg_amount}</span></div>
                  <div class="sb-line sb-line-05 global-currency {$prefix}">{$smarty.const.TEXT_AMOUNT}<span>{$stats.year.orders_amount}</span></div>
          ...
          <div class="summary-box summary-box-period">
              <div class="sbv">
                  ...
                  <a class="sb-line sb-line-01" href="{$app->urlManager->createUrl('customers')}">{$smarty.const.TEXT_CLIENTS}<span>{$stats.all.customers}</span></a>
                  <div class="dash-orders">
                    <div class="dash-orders-title">{$smarty.const.TEXT_ORDERS}</div>
                    <div class="dash-orders-sub-title after">
                        <div><a href="{$app->urlManager->createUrl('orders')}"><span class="stats_all_orders_not_processed">{$stats.all.orders_not_processed}</span>{$smarty.const.TEXT_NOT_PROCESSED_ORDERS_DASHBOARD}</a></div>
                        <div><a href="{$app->urlManager->createUrl('orders')}"><span class="stats_all_orders">{$stats.all.orders}</span>{$smarty.const.TEXT_ALL}</a></div>
                    </div>
                </div>
                  <div class="sb-line sb-line-04"><i>{$smarty.const.TEXT_AVERAGE_ORDER_VALUE}</i><span class="stats_all_orders_avg_amount">{$stats.all.orders_avg_amount}</span></div>
                  <div class="sb-line sb-line-05 global-currency {$prefix}">{$smarty.const.TEXT_AMOUNT}<span class="stats_all_orders_amount">{$stats.all.orders_amount}</span></div>
