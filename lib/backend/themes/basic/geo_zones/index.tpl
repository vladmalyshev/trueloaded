				...
				<!--<div class="row"  id="subzone_management" style="display: none;">
					<div class="col-md-12">
						<div class="widget box">
							...
							<div class="widget-content">
								<table class="table table-striped table-bordered table-hover table-responsive table-checkable datatable" id="subzones" checkable_list="0,1" data_ajax="geo_zones/content">
									<thead>
										<tr>
