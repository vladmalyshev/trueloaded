    ...
    <div class="widget-content">
        ...
        <div class="w-line-row w-line-row-1">
            <div class="wl-td">
                ...
                {Html::input('text', 'organization_site', $pInfo->organization_site, ['class' => 'form-control'])}
            </div>
        </div>
        <div class="w-line-row w-line-row-1">
            <div class="wl-td">
                <label>{$smarty.const.TEXT_ORGANIZATION_TYPE}:</label>
                {Html::dropDownList('organization_type', $pInfo->organization_type, $organization_types, ['class' => 'form-control'])}
            </div>
        </div>
        <div class="w-line-row w-line-row-1">
