...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $('#search-products-groups-assigned').on('focus keyup', { rows_selector: '#products-groups-assigned tr', text_selector: '.ast-name-products-group'}, searchHighlightExisting);
