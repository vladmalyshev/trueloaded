  ...
  <div class="row">
    <div class="col-md-12">
      <div class="widget-content">
        ...
        <table class="table table-striped table-bordered table-hover table-responsive table-checkable datatable double-grid table-no-search" checkable_list="0,1,2,3,4,5,6,7,9" data_ajax="purchase-report/list">
          <thead>
          <tr>
...
var fTable;
   ...
   function _export(){
     ...
     form.setAttribute('action', 'purchase-report/export?' + setFilterState(true));
     form.submit();
   }
