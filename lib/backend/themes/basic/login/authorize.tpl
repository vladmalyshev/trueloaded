                    ...
                    <form class="form-vertical login-form" action="{$app->urlManager->createUrl("login")}?action=process" method="post">
                        ...
                        <div class="form-group">
                            <div class="input-icon">
                                <i class="icon-lock"></i>
                                <input type="password" name="security_key" class="form-control" autocomplete="off" placeholder="{$smarty.const.TEXT_SECURITY_KEY}" data-rule-required="true" data-msg-required="{$smarty.const.TEXT_ENTER_SECURITY_KEY}" />
                            </div>
                        </div>
                        <div class="form-group">
