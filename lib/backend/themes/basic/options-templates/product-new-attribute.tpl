...
<tr role="row" class="js-option-value" data-option_value_id="{$option['products_options_values_id']}">
    ...
    <td class="name-ast">
        ...
        <input type="hidden" name="products_attributes_id[{$products_options_id}][{$option['products_options_values_id']}]" id="products_attributes_id_{$products_options_id}_{$option['products_options_values_id']}" value="{$option['options_templates_attributes_id']}" />
                                ...
                                <div class="tab-content tab-content-popup">
                                    ...
                                    {function attrWeightTab}
                                        ...
                                        <div class="our-pr-line after attr-virtual{$id_suffix}" {if !isset($option['products_file']) || $option['products_file']==''}style="display:none"{/if}>
                                            ...
                                            <div class="our-pr-line after">
                                                <a href="{$option['products_file_url']}">{$option['products_file']}</a><br>
                                        ...
                                        {if \common\helpers\Acl::checkExtension('TypicalOperatingTemp', 'attributesTemplateBlock')}
...
{if {!isset($productNewAttributeIncluded)} || {$productNewAttributeIncluded!==true} }
  {call newOptionValue options=$options options_templates_id=$options_templates_id products_options_id=$products_options_id isIncluded=false }
{/if}