...
<div class="row">
    <div class="col-md-4 js-edit-supplier-product-popup-container">
        ...
        <div class="js-edit-supplier-product-popup">
            <div class="row">
                <div class="col-md-12 js-bind-text bind-text">
            ...
            <div class="row">
                <div class="col-md-6 js-bind-text bind-text">
                ...
                {if ($pInfo->manual_stock_unlimited == 0)}
                <div class="col-md-6 js-bind-text bind-text">
            ...
            <div class="row">
                <div class="col-md-6 js-bind-text bind-text stock-reorder-supplier">
                    {if ($pInfo->manual_stock_unlimited == 0)}
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="s_td_group f_td_group-pr" style="position: relative">{Html::textInput('suppliers_data['|cat:$uprid|cat:']['|cat:$sInfo->suppliers_id|cat:'][source]', $sInfo->source, array_merge($options,['class'=>'form-control js-sources']))}</div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <label>{$smarty.const.TEXT_SUPPLIERS_LANDED_PRICE}</label>
                {Html::textInput('suppliers_data['|cat:$uprid|cat:']['|cat:$sInfo->suppliers_id|cat:'][landed_price]', $sInfo->landed_price, array_merge($options,['class'=>'form-control js-supplier-recalc']))}
            </div>
            <div class="col-md-6">
                <label>{$smarty.const.TEXT_SUPPLIERS_NOTES}</label>
                <textarea name="{'suppliers_data['|cat:$uprid|cat:']['|cat:$sInfo->suppliers_id|cat:'][notes]'}" rows="2" cols="32">{$sInfo->notes}</textarea>
            </div>
        </div>
        <div class="margined">
    ...
    <div class="col-md-8">
                    ...
                    <div class="js-edit-supplier-product-popup">
                        ...
                        <div class="show-in-popup">
                            <label>
                                ...
                                {Html::checkbox('suppliers_data['|cat:$uprid|cat:']['|cat:$sInfo->suppliers_id|cat:'][price_with_tax]', $price_with_tax, array_merge($options,['class'=>'js-supplier-tax-rate-flag js-supplier-recalc','style'=>'vertical-align:bottom','value'=>1]))}
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <hr>
        <div class="row">
            <div class="col-md-4 bs-supplier-price-cell">
                <label>{$smarty.const.TEXT_SUPPLIERS_OUR_PRICE}</label>
                <div class="row">
                    <div class="col-md-6"><div id="supplier_cost_price_net_{$idPart}"></div>{$smarty.const.TEXT_NET}</div>
                    <div class="col-md-6"><div id="supplier_cost_price_gross_{$idPart}"></div>{$smarty.const.TEXT_GROSS}</div>
                </div>
            </div>
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-6 bs-supplier-price-cell">
                        <label>{$smarty.const.TEXT_CALCULATED}</label>
                        <div class="row">
                            <div class="col-md-6"><div id="calc_net_price_{$idPart}"></div>{$smarty.const.TEXT_NET}</div>
                            <div class="col-md-6"><div id="calc_gross_price_{$idPart}"></div>{$smarty.const.TEXT_GROSS}</div>
                        </div>
                    </div>
                    <div class="col-md-6 bs-supplier-price-cell">
                        <label>{$smarty.const.TEXT_OUR_PROFIT}</label>
                        <div id="calc_profit_{$idPart}" class="supplier-big-price"></div>
                    </div>

                    <div class="col-md-6 bs-supplier-price-cell bs-background-gray">
                        <label>{$smarty.const.TEXT_OUR_CURRENT}</label>
                        <div class="row">
                            <div class="col-md-6"><div id="our_net_price_{$idPart}"></div>{$smarty.const.TEXT_NET}</div>
                            <div class="col-md-6"><div id="our_gross_price_{$idPart}"></div>{$smarty.const.TEXT_GROSS}</div>
                        </div>
                    </div>
                    <div class="col-md-6 bs-supplier-price-cell bs-background-gray">
                        <label>{$smarty.const.TEXT_OUR_CURRENT_PROFIT}</label>
                        <div id="our_profit_{$idPart}" class="supplier-big-price"></div>
                    </div>
                </div>
            </div>
        </div>
