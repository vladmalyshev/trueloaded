...
<div class="is-virtual-upload"{if $pInfo->is_virtual == 0} style="display: none;"{/if}>
  ...
  {$app->controller->view->productFile}
</div>
<div class="is-virtual"{if $pInfo->is_virtual == 1} style="display: none;"{/if}>
  ...
  <div class="cartoon_wrapper">
    {if \common\helpers\Acl::checkExtension('PackUnits', 'productBlock')}
      {\common\extensions\PackUnits\PackUnits::productBlock($pInfo, $app->controller->view->pack_unit_price_tabs_data, $app->controller->view->packaging_unit_price_tabs_data)}
    {else}
        <div class="widget box box-no-shadow">
            <div class="widget-header"><h4>{$smarty.const.TEXT_PRODUCT_SIZE}</h4></div>
            <div class="widget-content dis_module after">
                <div class="size-pack-col">
                    <div class="edp-line">
                        <label>{$smarty.const.TEXT_PRODUCT_UNIT_SIZE}</label>
                        <input type="text" name="" value="1" class="form-control form-control-small" disabled>
                    </div>
                    <div class="dimmens_cm dimmens">
                        <div class="edp-line">
                            <label class="addcolonm">{$smarty.const.TEXT_DIMENSIONS_CM}</label>
                            <input type="text" class="form-control form-control-small" disabled>
                        </div>
                        <div class="edp-line">
                ...
                <div class="size-pack-col dimmens_in dimmens">
                    <div class="edp-line">
                        <label class="addcolonm">{$smarty.const.TEXT_DIMENSIONS_IN}</label>
                        <input type="text" value="{$pInfo->dimensions_in}" class="form-control form-control-small" disabled>
                    </div>
                    <div class="edp-line">
                        <label class="addcolonm">{$smarty.const.TEXT_LENGTH_IN}</label>
                        <input type="text" class="form-control form-control-small" disabled>
                    </div>
                    <div class="edp-line">
                        <label class="addcolonm">{$smarty.const.TEXT_WIDTH_IN}</label>
                        <input type="text" class="form-control form-control-small" disabled>
                    </div>
                    <div class="edp-line">
                        <label class="addcolonm">{$smarty.const.TEXT_HEIGHT_IN}</label>
                        <input type="text" class="form-control form-control-small" disabled>
                    </div>
                    <div class="edp-line">
      ...
      <div class="widget box box-no-shadow">
        <div class="widget-header"><h4>{$smarty.const.TEXT_CARTON_SIZE}</h4></div>
        <div class="widget-content after dis_module">
          <div class="size-pack-col">
            <div class="edp-line">
              <label class="addcolonm">{$smarty.const.TEXT_PACK_UNIT}</label>
              <input type="text" class="form-control form-control-small" disabled>
            </div>
            <div class="dimmens_cm dimmens">
              <div class="edp-line">
          ...
          <div class="emp-line">&nbsp;</div>
          <div class="edp-line">
            <label class="addcolonm">{$smarty.const.TEXT_PRICE_COST_W}</label>
            <a href="javascript:void(0)" class="btn">{$smarty.const.SET_UP_DETAILS}</a>
          </div>
        </div>
      </div>
      <div class="widget box box-no-shadow">
        <div class="widget-header"><h4>{$smarty.const.TEXT_OUTER_CARTON}</h4></div>
        <div class="widget-content after dis_module">
          <div class="size-pack-col">
            <div class="edp-line">
              <label class="addcolonm">{$smarty.const.TEXT_PACKAGING}</label>
              <input type="text" class="form-control form-control-small" disabled>
            </div>
            <div class="edp-line">
              <label class="addcolonm">{$smarty.const.TEXT_PACK_UNIT}</label>
                    ...
                    <div class="tab-pane" id="tab_packaging-{$groups_id}">
                      ...
                      <div class="t-row js_packaging_group_fullprice" data-uprid="packaging" data-group_id="{$groups_id}" data-group_discount="{$group['groups_discount']}">
                        ...
                        <div class="js_inventory_price_block">
                          <div class="t-col-3">
                            <label for="">{$smarty.const.TEXT_NET_PRICE}</label>
                            <div class=""><input type="text" name="packaging_full_prices[{$groups_id}]" value="{$app->controller->view->products_group_price_packaging[$groups_id]}" class="form-control form-control-small js_inventory_price_input" onkeyup="updateGross()"></div>
                          </div>
                          <div class="t-col-3">
                            <label for="">{$smarty.const.TEXT_GROSS_PRICE}</label>
