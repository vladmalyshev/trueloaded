        ...
        <div class="widget box box-no-shadow" style="margin-bottom: 5px;">
            ...
            <div class="widget-content">
                ...
                <div class="edp-line">
                    ...
                    {tep_draw_pull_down_menu('products_pctemplates_id', \common\helpers\Configurator::get_pctemplates(), $pInfo->products_pctemplates_id, 'readonly="readonly" disabled="disabled" class="form-control"')}
                </div>
            </div>
        </div>
