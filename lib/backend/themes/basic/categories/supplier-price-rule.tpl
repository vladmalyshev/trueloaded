...
<tr class="js-supplier-rule-row">
    ...
    <td class="js-cond js-cond-fromTo">
        {if $rulesRO}{$rule['supplier_price_from']}{else}
    ...
    <td class="js-cond js-cond-fromTo">
        {if $rulesRO}{$rule['supplier_price_to']}{else}
    ...
    <td class="js-cond js-cond-notBelow">
        {if $rulesRO}{$rule['supplier_price_not_below']}{else}
    ...
    <td>
        {if $rulesRO}{$rule['price_formula_text']}{else}
    ...
    <td>
        {if $rulesRO}
            {if is_null($rule['supplier_discount'])}
                {$default_rule['supplier_discount']}
            {else}
    ...
    <td>
        {if $rulesRO}
            {if is_null($rule['surcharge_amount'])}
                {$default_rule['surcharge_amount_formatted']}
            {else}
    ...
    <td>
        {if $rulesRO}
            {if is_null($rule['margin_percentage'])}
                {$default_rule['margin_percentage']}
            {else}
