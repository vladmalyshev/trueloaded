...
{/if}
                  ...
                  {function attrWeightTab}
                    {$id_suffix = "`$option['products_options_id']`_`$option['products_options_values_id']`"}
                      ...
                      {if \common\helpers\Acl::checkExtension('TypicalOperatingTemp', 'attributesBlock')}
                      {\common\extensions\TypicalOperatingTemp\TypicalOperatingTemp::attributesBlock($option)}
                      {/if}
                  {/function}
