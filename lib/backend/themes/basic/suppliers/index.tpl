    ...
    <div class="col-md-12">
      <div class="widget-content">     
        {if {$messages|@count} > 0}
          ...
          {/foreach}
        {/if}
        <table class="table table-striped table-bordered table-hover table-responsive table-checkable table-selectable js-table-sortable datatable table-suppliers double-grid" checkable_list="0,1,2" data_ajax="{$app->urlManager->createUrl('suppliers/list')}">
          <thead>
            <tr>
