...
<div class=""><span data-href="{$mItem['svg_url']}" class="btn btn-edit-svg">{$smarty.const.IMAGE_EDIT} SVG</span></div>
                                        ...
                                        <tr class="banner-image-{$mKey}"{if $mItem['banner_display'] == '1' || $mItem['banner_display'] == '3'} style="display: none"{/if}>
                                    ...
                                    {\backend\design\Image::widget([
                                        ...
                                        <tr class="banner-text-{$mKey}"{if $mItem['banner_display'] == '0' || $mItem['banner_display'] == '3'} style="display: none"{/if}>
        ...
        function groupsSizes(){
            ...
            $.get('banner_manager/banner-group-images', {
                ...
                $('.banner-groups-images').each(function(){
                    $(this).html(data[$(this).data('language_id')])
                })
            }, 'json')
        }
    })
