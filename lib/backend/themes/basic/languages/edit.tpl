              ...
              <div class="tab-content">
                <div class="tab-pane topTabPane tabbable-custom active" id="tab_main">
                      ...
                      {if $lang['languages_status'] eq 1}
                        {$smarty.const.IMAGE_ICON_STATUS_GREEN_LIGHT}&nbsp;&nbsp;{Html::checkbox('flag', true, ['class' => 'check_on_off'])}
                      {else}
                        {$smarty.const.IMAGE_ICON_STATUS_RED_LIGHT}&nbsp;&nbsp;{Html::checkbox('flag', false, ['class' => 'check_on_off'])}
                      {/if}
                          </div>
                       </div>
