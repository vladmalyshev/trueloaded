...
<div class="widget box" {if $currentDirectory->cron_enabled}style="display:none"{/if}>
    ...
    <div class="widget-content fields_style" id="easypopulate_upload_files_data">
        <form name="frmUpload" id="frmUpload" enctype="multipart/form-data" action="{$upload_form_action}" METHOD="POST">
            <div class="row">
                ...
                <div class="col-md-8">
                    <p>
                    {Html::dropDownList('file_type',0, $importProviders['items'], $importProviders['options'])}
                    </p>
                    <p>
