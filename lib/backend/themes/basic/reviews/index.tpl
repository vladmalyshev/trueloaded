        ...
        <div class="filter-box">
            <form id="filterForm" name="filterForm" onsubmit="return applyFilter();">
                ...
                <div class="f_row">
                    ...
                    <input id="from_date" type="text" autocomplete="off" name="from" value="{$app->controller->view->filters->from}" class="datepicker form-control form-control-small">
                    <span class="sp_marg">{$smarty.const.TEXT_TO}</span>
                    <input id="to_date" type="text" autocomplete="off" name="to" value="{$app->controller->view->filters->to}" class="datepicker form-control form-control-small">
                    </div>
                </div>
                <div class="f_row">
                    <div class="f_td"></div>
