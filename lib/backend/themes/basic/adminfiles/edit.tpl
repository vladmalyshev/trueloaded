        ...
        <div class="create-or-wrap after create-cus-wrap">
            <div class="widget box box-no-shadow" style="margin-bottom: 0;">
                ...
                <div class="widget-content">
                    <div class="wl-td">
                        <label>{$smarty.const.ENTRY_ACCESS_LEVELS_NAME}<span class="fieldRequired">*</span></label>{Html::input('text', 'access_levels_name', $accessInfo->access_levels_name, ['class' => 'form-control', 'required' => true])}
                    </div>
