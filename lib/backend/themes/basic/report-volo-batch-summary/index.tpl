...
<div class="order-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="widget-content">
                ...
                <table class="table table-striped table-bordered table-hover table-responsive table-checkable datatable double-grid table-no-search" checkable_list="0" data_ajax="report-volo-batch-summary/list">
                    <thead>
                        <tr>
    ...
    <script type="text/javascript">
        ...
        function _export() {
            ...
            form.setAttribute('action', 'report-volo-batch-summary/export?' + setFilterState(true));
            form.submit();
        }
    </script>
    <!-- /Page Content -->
