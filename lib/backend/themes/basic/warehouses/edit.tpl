        ...
        <div class="cbox-left">
                ...
                <div class="widget-content">
                    ...
                    <div class="w-line-row w-line-row-1">
                        <div class="wl-td">
                            ...
                            {Html::checkbox('status', $pInfo->status,  array_merge(['value'=>'1', 'class' => 'js_check_status'], $checkbox_default_warehouse_attr))}
                        </div>
                    </div>
                    {/if}
                    {else}
                    ...
                    <div class="w-line-row w-line-row-1">
                        <div class="wl-td">
                            <label>{$smarty.const.ENTRY_WAREHOUSE_OWNER}<span class="fieldRequired">*</span></label>{Html::input('text', 'warehouse_owner', $pInfo->warehouse_owner, ['class' => 'form-control', 'required' => true])}
                        </div>
                    </div>
                    {/if}
                    <div class="w-line-row w-line-row-1">
                        <div class="wl-td">
                            <label>{$smarty.const.ENTRY_WAREHOUSE_NAME}<span class="fieldRequired">*</span></label>{Html::input('text', 'warehouse_name', $pInfo->warehouse_name, ['class' => 'form-control', 'required' => true])}
                        </div>
                    </div>
                    <div class="w-line-row w-line-row-1">
                        <div class="wl-td">
                            <label>{$smarty.const.ENTRY_IS_STORE}</label>
                            {Html::checkbox('is_store', $pInfo->is_store, ['value'=>'1', 'class' => 'js_check_is_store'])}
                        </div>
                    </div>
                    {if $have_one_or_more_warehouse}
                    <div class="w-line-row w-line-row-1">
                        <div class="wl-td">
                            ...
                            {Html::checkbox('is_default', !!$pInfo->is_default, array_merge(['value'=>'1', 'class' => 'js_check_default_warehouse'], $checkbox_default_warehouse_attr))}
            ...
            <div class="widget box box-no-shadow">
                ...
                <div class="widget-content">
                    <div class="w-line-row w-line-row-1">
                        <div class="wl-td">
                            <label>{$smarty.const.ENTRY_EMAIL_ADDRESS}<span class="fieldRequired">*</span></label>{Html::input('email', 'warehouse_email_address', $pInfo->warehouse_email_address, ['class' => 'form-control', 'required' => true, 'data-pattern' => 'email'])}
                        </div>
                    </div>
                    <div class="w-line-row w-line-row-2">
                        <div class="wl-td">
                            <label>{$smarty.const.ENTRY_TELEPHONE_NUMBER}</label>{Html::input('text', 'warehouse_telephone', $pInfo->warehouse_telephone, ['class' => 'form-control'])}
                        </div>
                        <div class="wl-td">
                            <label>{$smarty.const.ENTRY_LANDLINE}</label>{Html::input('text', 'warehouse_landline', $pInfo->warehouse_landline, ['class' => 'form-control'])}
                        </div>
                    </div>
                    <div class="w-line-row w-line-row-1 w-line-row-req">
                          <span style="color: #f2353c; margin: 22px 0 0; display: block;">{$smarty.const.ENTRY_REQUIRED_FIELDS}</span>
        ...
        <div class="cbox-right">
            <div class="widget box box-no-shadow" style="min-height: 481px;">
                ...
                <div class="widget-content">
                    ...
                    <div class="w-line-row w-line-row-1">
                        <div class="wl-td">
                            <label>{$smarty.const.ENTRY_COMPANY}</label>{Html::input('text', 'entry_company[]', $addresses->entry_company, ['class' => 'form-control'])}
                        </div>
                    </div>
                    <div class="w-line-row w-line-row-2">
                        <div class="wl-td">
                            <label>{$smarty.const.ENTRY_BUSINESS}</label>{Html::input('text', 'entry_company_vat[]', $addresses->entry_company_vat, ['class' => 'form-control'])}
                        </div>
                        <div class="wl-td">
                            <label>{$smarty.const.ENTRY_BUSINESS_REG_NUMBER}</label>{Html::input('text', 'entry_company_reg_number[]', $addresses->entry_company_reg_number, ['class' => 'form-control'])}
                        </div>
                    </div>
                    ...
                    <div class="w-line-row w-line-row-2">
                        <div class="wl-td">
                            <label>{$smarty.const.ENTRY_POST_CODE}</label>{Html::input('text', 'entry_postcode[]', $addresses->entry_postcode, ['class' => 'form-control'])}
                        </div>
                        <div class="wl-td">
                            <label>{$smarty.const.ENTRY_STREET_ADDRESS}</label>{Html::input('text', 'entry_street_address[]', $addresses->entry_street_address, ['class' => 'form-control'])}
                        </div>
                    </div>
                    <div class="w-line-row w-line-row-2">
                        <div class="wl-td">
                            <label>{$smarty.const.ENTRY_SUBURB}</label>{Html::input('text', 'entry_suburb[]', $addresses->entry_suburb, ['class' => 'form-control'])}
                        </div>
                        <div class="wl-td">
                            <label>{$smarty.const.ENTRY_CITY}</label>{Html::input('text', 'entry_city[]', $addresses->entry_city, ['class' => 'form-control'])}
                        </div>
                    </div>
                    <div class="w-line-row w-line-row-2">
                        <div class="wl-td">
                            ...
                            <div class="f_td_state">
                                {Html::input('text', 'entry_state[]', $addresses->entry_state, ['class' => 'form-control', 'id' => "selectState"])}
                            </div>
                        </div>
                        <div class="wl-td">
                            <label>{$smarty.const.ENTRY_COUNTRY}<span class="fieldRequired">*</span></label>{Html::dropDownList('entry_country_id[]', $addresses->entry_country_id, \common\helpers\Country::new_get_countries('', false), ['class' => 'form-control', 'id' => "selectCountry", 'required' => true])}
                        </div>
                    </div>
                ...
                <div class="widget-content">
                    <div class="w-line-row w-line-row-2">
                        <div class="wl-td">
                            ...
                            {Html::input('text', 'shipping_additional_charge', $pInfo->shipping_additional_charge, ['class' => 'form-control'])}
                        </div>
                    </div>
                </div>
            </div>

            {Html::input('hidden', 'warehouses_address_book_id[]', $addresses->warehouses_address_book_id)}
        </div>        
    </div>
        <div class="create-or-wrap after create-cus-wrap yes_store" {if $pInfo->is_store == 0}style="display: none;"{/if}>
        <div class="cbox-left">
    <div class="widget box box-no-shadow" style="min-height:183px;">
        ...
        <div class="widget-content">
            ...
            <div class="w-line-row opening_hours">
                ...
                {Html::input('hidden', 'warehouses_open_hours_id[]', $open_hour->warehouses_open_hours_id)}
...
{Html::input('hidden', 'id', $pInfo->warehouse_id)}
</form>
