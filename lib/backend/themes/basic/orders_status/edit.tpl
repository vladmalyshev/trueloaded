...
<div class="container form-container">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            {tep_draw_checkbox_field('order_evaluation_state_default', '1', $oInfo->order_evaluation_state_default)}
        </div>
    </div>
    {/if}
    <div class="row">
        ...
        <div class="col-md-4">
            {tep_draw_pull_down_menu('orders_status_template', $orders_status_template, $oInfo->orders_status_template, 'class="form-control"')}
        </div>
    </div>
    <div class="row">
        <div class="col-md-2"><label>{$smarty.const.TEXT_ORDERS_STATUS_TEMPLATE_CONFIRM}</label></div>
        <div class="col-md-4">
            {tep_draw_pull_down_menu('orders_status_template_confirm', $orders_status_template, $oInfo->orders_status_template_confirm, 'class="form-control"')}
        </div>
    </div>
    <div class="row">
        <div class="col-md-2"><label>{$smarty.const.TEXT_ORDERS_STATUS_TEMPLATE_SMS}</label></div>
        <div class="col-md-4">
            {tep_draw_pull_down_menu('orders_status_template_sms', $orders_status_template_sms, $oInfo->orders_status_template_sms, 'class="form-control"')}
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            {tep_draw_checkbox_field('automated', '1', $oInfo->automated)}
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            {tep_draw_checkbox_field('orders_status_send_ga', '1', $oInfo->orders_status_send_ga, '', 'disabled')}
        </div>
    </div>
    <div class="row">
        <div class="col-md-2"><label for='hidden'>{$smarty.const.TEXT_INACTIVE}</label></div>
        <div class="col-md-4">
            {Html::checkbox('hidden', $oInfo->hidden, ['class'=> 'check_on_off'])}
        </div>
    </div>
</div>
...
{if \common\helpers\Acl::checkExtension('OrderStatusRules', 'orderStatusEditBlock')}
