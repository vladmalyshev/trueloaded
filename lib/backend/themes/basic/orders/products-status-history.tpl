            ...
            if (status == 'success') {
                if (response.status == 'ok') {
                    $.each(response.op, function(opId) {
                        ...
                        $('#products-qty-cnld-' + opId).text(this.qty_cnld);
                        $('#products-qty-rcvd-' + opId).text(this.qty_rcvd - this.qty_dspd);
                        $('#products-qty-dspd-' + opId).text(this.qty_dspd - this.qty_dlvd);
                        $('#products-qty-dlvd-' + opId).text(this.qty_dlvd);
                    });
