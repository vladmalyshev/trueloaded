...
<div class="popup-heading">{$smarty.const.POPUP_HEADING_ORDER_PAYMENT_ADD}</div>
            ...
            <div class="widget-content usc-box usc-box2">
                <div class="f_tab">
                    <div class="f_row">
                        ...
                        <div class="f_td">
                            {tep_draw_pull_down_menu('orders_payment_module', $paymentArray, '', 'class="form-control"')}
                        </div>
                    </div>
                    <div class="f_row">
                        <div class="f_td">
                    ...
                    <div class="f_row">
                        ...
                        <div class="f_td">
                            {tep_draw_pull_down_menu('orders_payment_currency', $currencyArray, $currencyDefaultCode, 'class="form-control"')}
                        </div>
                    </div>
                    <div class="f_row">
                        <div class="f_td">
