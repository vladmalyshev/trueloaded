...
{Html::beginForm(Url::toRoute(['order/', 'action' => 'confirmed-order-reassign']),'post', ['id' => 'orders_edit', 'onSubmit' => "return confirmedReassignOrder();"])}
    ...
    <div class="btn-toolbar btn-toolbar-order">
        {Html::submitButton($smarty.const.IMAGE_REASSIGN, ['class' => 'btn btn-delete btn-no-margin'])}
        <input type="button" class="btn btn-cancel" value="{$smarty.const.IMAGE_CANCEL}" onClick="return cancelStatement()">
