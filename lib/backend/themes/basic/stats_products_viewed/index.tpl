           ...
           <!--=== Page Content ===-->
              ...
              -->                
							...
							<div class="widget-content">
								<table class="table table-striped table-bordered table-hover table-responsive table-checkable datatable" checkable_list="0,1,2" data_charts ="chart-canvas" data_ajax="stats_products_viewed/list">
									<thead>
										<tr>
        ...
        <script  type="text/javascript">
          ...
          onDraw = function(data){
            ...
            $.each(data, function(i,e ){
              ...
              legend += '<li>' + e[1] + ': <b>' + e[2] + '</b> viewed</li>';
            });
            legend += '</ul>';
