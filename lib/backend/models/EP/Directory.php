...
class Directory extends BaseObject
{
    ...
    {
        return $this->parent_id!=0 && $this->removable && !empty($this->directory_id) && !in_array($this->directory_type, [self::TYPE_IMAGES]);
    }
    ...
    public function delete()
    {
        ...
        tep_db_query("DELETE FROM ".TABLE_EP_DIRECTORIES." WHERE directory_id='".$this->directory_id."'");
        self::getAll(true);
