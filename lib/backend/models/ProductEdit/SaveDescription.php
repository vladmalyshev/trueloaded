            ...
            foreach($platforms as $platform){
                for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                    ...
                    if (isset($posted_description[$platform->platform_id][$language_id])){
                        ...
                        if (is_array($posted_description[$platform->platform_id][$language_id]['products_h2_tag']))
                        ...
                        if (is_array($posted_description[$platform->platform_id][$language_id]['products_h3_tag']))
                        ...
                        $pDescription->overwrite_head_title_tag = (int)$posted_description[$platform->platform_id][$language_id]['overwrite_head_title_tag'];
                        $pDescription->overwrite_head_desc_tag = (int)$posted_description[$platform->platform_id][$language_id]['overwrite_head_desc_tag'];
