            ...
            foreach ($products_images_id as $pointer => $imageId) {
                ...
                foreach ($orig_file_name[$pointer] as $language_id => $orig_file) {
                    ...
                    $image_description = [
                        ...
                        'alt_file_name' =>((int)$alt_file_name_flag[$pointer][$language_id] == 0)?'':$alt_file_name[$pointer][$language_id],
                        'no_watermark' => (int)$no_watermark[$pointer][$language_id],
                        ...
                        'use_origin_image_name' => (int)$use_origin_image_name[$pointer][$language_id],
                    ];
