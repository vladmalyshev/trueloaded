...
///vl2do          save attributes and inventory
            ...
            */
            ...
            foreach ($attributes_array as $val) {
                ...
                if ($ext = \common\helpers\Acl::checkExtension('TypicalOperatingTemp', 'saveProductAttribute')) {
                ...
                ///group prices
                if ($without_inventory || PRODUCTS_INVENTORY != 'True' || \common\helpers\Attributes::is_virtual_option($option_id)) {
            ...
            if (PRODUCTS_INVENTORY == 'True' && !$without_inventory) {
                ...
                foreach ($inventory_options as $tmp) {
                    ...
                    if ($products_price_full) {
                        ...
                        if ($ext = \common\helpers\Acl::checkExtension('AttributesQuantity', 'allowed')) {
...
//in tpl currency_id should be always correct, so w/o market price: $post_currencies_id (15) => $currencies_id (0)
            ...
            }elseif (PRODUCTS_INVENTORY == 'True' && $without_inventory) {
