    ...
    public function populateView($view)
    {
        ...
        while ($images_data = tep_db_fetch_array($images_query)) {
            ...
            for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
                ...
                $imageSize = null;
                $imageSrc = DIR_FS_CATALOG . DIR_WS_IMAGES . 'products' . '/' . $images_data['products_id'] . '/' . $images_description['products_images_id'] . '/' . $images_description['hash_file_name'];
                ...
                $description[$languages[$i]['id']] = [
                    ...
                    'use_origin_image_name' => $images_description['use_origin_image_name'],
                    ...
                    'external_image_original' => $images_description['external_image_original'],
                    ...
                    'imageSize' => $imageSize,
                    'use_external_images' => !!$images_description['use_external_images'],
                    'external_images' => $_ext_images_array,
                ];
            }

            $inventory = [];
            if (is_array($view->selectedInventory)) {
