...
class CategoryPagesLastListBlock extends Widget
{
    ...
    public function run()
    {
        ...
        if (!isset($this->settings[0]['limitInformationLastListBlock'])) {
            $this->settings[0]['limitInformationLastListBlock'] = 6;
        }

        return $this->render('../../views/category-page-last-list-block.tpl', [
            'id' => $this->id,
            'params' => $this->params,
