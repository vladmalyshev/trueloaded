            ...
            <div class="tab-content">
                <div class="tab-pane active menu-list" id="type">
                    ...
                    <div class="setting-row">
                        ...
                        {Html::dropDownList('setting[0][selectCatalogPageLastListById]', $settings[0].selectCatalogPageLastListById, $catalogPages,  ['class' => 'form-control'])}
                    </div>
                    <div class="setting-row">
                        <label for="">{$smarty.const.TEXT_COUNT_ON_PAGE}</label>
                        {Html::input('text', 'setting[0][limitInformationLastListByIdPage]', $settings[0].limitInformationLastListByIdPage, ['class' =>'form-control'])}
                    </div>
