...
{Html::dropDownList('payment_class', '', $list, ['class' => 'form-control', 'id' => 'search_payment_class', 'prompt' => 'Please select payment'])}
...
<br/>
{Html::button('Get list', ['id' => 'search-transactions', 'class' => 'btn btn-primary'])}
