            ...
            foreach ($modules as $module){
                if (is_array($module->output) && count($module->output)) {
                    for ($i = 0; $i < count($module->output); $i++) {
                        $this->js .= 'var ' . $module->code . ' = {prefix: "' . $module->output[$i]['prefix'] . '", sort_order:"' . $module->sort_order . '"};' . "\n";
        ...
        switch($module->code){
            ...
            case 'ot_refund':
                ...
                return [
                        ...
                        ($module->code == 'ot_paid'? '<div class="totals edit-paid"><i class="icon-pencil"></i></div>'.
    ...
    private function drawEditabelRow($module, $index, array $params){
        ...
        if ($module->code == 'ot_custom'){
            ...
            return [
                ...
                '<div class="totals edit-pt"><i class="icon-pencil"></i></div> ' . ($module->code != 'ot_shipping'? '<div class="totals del-pt" onclick="removeModule(\'' . $module->code . '\')"></div>': '<div class="totals"></div>'),
            ];
        }
    }
