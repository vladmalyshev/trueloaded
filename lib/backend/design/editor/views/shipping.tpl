                    ...
                    <div class="item" {if isset($shipping_quote_item.hide_row) && $shipping_quote_item.hide_row}style="display: none;"{/if}>
                        ...
                        {else}
                            {foreach $shipping_quote_item.methods as $shipping_quote_item_method}
                                <div class="subItem">
                                    <label class="row">
                                        <div class="input"><input value="{$shipping_quote_item_method.code}" {if $shipping_quote_item_method.selected}checked="checked"{/if} type="radio" name="shipping" data-widget="{if $shipping_quote_item.widget}{$shipping_quote_item.id}{/if}"/></div>
                                        <div class="cost">{$shipping_quote_item_method.cost_f}</div>
                                        <div class="sub-title">{$shipping_quote_item_method.title}</div>
                                    </label>
                                    {if $shipping_quote_item_method.widget}
