...
<div class="widget box box-no-shadow">
    <div class="widget-header widget-header-personal">
        ...
        {if $manager->isCustomerAssigned() || $manager->getCustomersIdentity()->get('fromOrder')}
            ...
            <span class="cus-name cust-style">{$customer->customers_firstname} {$customer->customers_lastname}</span>
            ...
            <span class="cust-style">/</span> <span class="icon-phone cust-style"> {$customer->customers_telephone}</span>
            {/if}
        {else}
