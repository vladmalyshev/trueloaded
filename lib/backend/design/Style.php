...
class Style
{
    ...
    public static function getAttributes($attributes, $displacement = '', $br = '', $anyAttributes = false)
    {
            ...
            foreach ($attributes as $attr => $val) {
                if (isset($val)) {
                    if (in_array($attr, $attributesNoRules)) {
                        ...
                        $style .= $displacement . $attr . ': ' . $val . $importantArr[$attr] . ';' . $br;

                    } elseif (in_array($attr, $attributesHasMeasure)) {

                        $style .= $displacement . $attr . ':' . $val . ($val == '0' ? '' : self::dimension($attributes[str_replace('-', '_', $attr) . '_measure'], '', $val)) . $importantArr[$attr] . ';' . $br;
        ...
        if ($attributes['display']=='flex' && !$displacement) {
        ...
        if (isset($attributes['line-height'])) {
            $style .= $displacement . 'line-height:' . $attributes['line-height'] . ($attributes['line_height_measure'] ? self::dimension($attributes['line_height_measure']) : '') . ';' . $br;
        }
        if (isset($attributes['rotate'])) {
            $style .= $displacement . '-ms-transform:rotate(' . $attributes['rotate'] . 'deg);-webkit-transform:rotate(' . $attributes['rotate'] . 'deg);transform:rotate(' . $attributes['rotate'] . 'deg)' . $importantArr['rotate'] . ';' . $br;
        }
        if ($attributes['content']) {
            $style .= $displacement . 'content:\'' . ($attributes['content'] == '\_' ? '' : $attributes['content']) . '\'' . $importantArr['content'] . ';' . $br;
        }
        if ($attributes['display']) {
            $style .= $displacement . 'display:' . $attributes['display'] . $importantArr['display'] . ';' . $br;
        ...
        if ($attributes['font-family'] && !$_GET['to_pdf']){
            if (Yii::$app->controller->action->id == 'get-css' || stripos($attributes['font-family'], "'") !== false || stripos($attributes['font-family'], '"') !== false) {
                ...
                if ($attributes['font-family'] == 'inherit') {
                    ...
                    $style .= $displacement . 'font-family:\'' . $attributes['font-family'] . '\', Verdana, Arial, sans-serif' . $importantArr['font-family'] . ';' . $br;
                }
            }
        }
        if (
            ...
            if ($text_shadow_size && $text_shadow_color){
                $style .= $displacement . 'text-shadow:' . $text_shadow_left.' '.$text_shadow_top.' '.$text_shadow_size.' '.$text_shadow_color . $importantArr['text-shadow'] . ';' . $br;
            }
        }
        if (
            ...
            $box_shadow_left = $attributes['box_shadow_left'];
            $box_shadow_top = $attributes['box_shadow_top'];
            $box_shadow_blur = $attributes['box_shadow_blur'];
            $box_shadow_spread = $attributes['box_shadow_spread'];
            ...
            $style .= $displacement . 'box-shadow:' . $attributes['box_shadow_set'].' ' . $box_shadow_left.' '.
                $box_shadow_top.' '.$box_shadow_blur.' '.$box_shadow_spread.' '.$attributes['box_shadow_color'] . $importantArr['box-shadow'] . ';' . $br;
        }
        if ($attributes['background_image']){
            $style .= $displacement . 'background-image:url(\'' . \frontend\design\Info::themeImage($attributes['background_image']) . '\')' . $importantArr['background-image'] . ';' . $br;
        }
        ...
        $borderRight = '';
        $borderBottom = '';
        if (isset($attributes['border-top-width']) && $attributes['border-top-color']) {
            $borderTop =
                $attributes['border-top-width'] .
                self::dimension($attributes['border_top_width_measure']) .
                ($attributes['border-top-style'] ? ' ' . $attributes['border-top-style'] . ' ' : ' solid ') .
            ...
            if ($attributes['border-top-color']) {
                $style .= $displacement . 'border-top-color:' . $attributes['border-top-color'] . $importantArr['border-top-color'] . ';' . $br;
            }
            if ($attributes['border-top-style']) {
                $style .= $displacement . 'border-top-style:' . $attributes['border-top-style'] . $importantArr['border-top-style'] . ';' . $br;
            }
        }
        if (isset($attributes['border-left-width']) && $attributes['border-left-color']) {
            $borderLeft =
                $attributes['border-left-width'] .
                self::dimension($attributes['border_left_width_measure']) .
                ($attributes['border-left-style'] ? ' ' . $attributes['border-left-style'] . ' ' : ' solid ') .
        ...
        if (isset($attributes['border-bottom-width']) && $attributes['border-bottom-color']) {
            $borderBottom =
                ...
                ($attributes['border-bottom-style'] ? ' ' . $attributes['border-bottom-style'] . ' ' : ' solid ') .
        ...
        if (
            ...
            if (isset($attributes['padding-top'])) {
                $style .= $displacement . 'padding-top:' . $attributes['padding-top'] . self::dimension($attributes['padding_top_measure']) . $importantArr['padding-top'] . ';' . $br;
            }
            if (isset($attributes['padding-right'])) {
                $style .= $displacement . 'padding-right:' . $attributes['padding-right'] . self::dimension($attributes['padding_right_measure']) . $importantArr['padding-right'] . ';' . $br;
            }
            if (isset($attributes['padding-bottom'])) {
                $style .= $displacement . 'padding-bottom:' . $attributes['padding-bottom'] . self::dimension($attributes['padding_bottom_measure']) . $importantArr['padding-bottom'] . ';' . $br;
            }
            if (isset($attributes['padding-left'])) {
                $style .= $displacement . 'padding-left:' . $attributes['padding-left'] . self::dimension($attributes['padding_left_measure']) . $importantArr['padding-left'] . ';' . $br;
            }
        }
        ...
        if (
            ...
            } elseif ($attributes['margin_right_measure'] == $attributes['margin_right_measure' == 'auto']) {
                $style .= $displacement . 'margin:' .
    ...
    public static function cssImportant($importantArr, $attr)
    {
        if (
            $importantArr[$attr]
            || $importantArr[$attr . '-top']
            || $importantArr[$attr . '-left']
            || $importantArr[$attr . '-right']
            || $importantArr[$attr . '-bottom']
        ){
            return '!important';
        }
    }
    ...
    public static function getCssWidgetsList($theme_name)
    {
        ...
        $query = tep_db_query("select distinct accessibility from " . TABLE_THEMES_STYLES . " where theme_name = '" . $theme_name . "' order by accessibility");
