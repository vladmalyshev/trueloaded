...
define('TABLE_FEATURES_TYPES', 'features_types');
define('TABLE_DEPARTMENTS_TO_FEATURES', 'departments_to_features');
...
define('TABLE_DESIGN_BOXES_BACKUPS', 'design_boxes_backups');
define('TABLE_DESIGN_BOXES_SETTINGS_BACKUPS', 'design_boxes_settings_backups');
define('TABLE_THEMES_SETTINGS_BACKUPS', 'themes_settings_backups');
define('TABLE_THEMES_STYLES_BACKUPS', 'themes_styles_backups');
...
define('TABLE_LANGUAGES_DATA', 'languages_data');
...
define('TABLE_ADMIN_SHOPPING_CARTS', 'admin_shopping_carts');
...
define('TABLE_SMS_DEFAULTS', 'sms_defaults');
define('TABLE_SMS_DEFAULTS_TEXTS', 'sms_defaults_texts');
...
define('TABLE_GAPI_SEARCH', 'gapi_search');
define('TABLE_GAPI_SEARCH_TO_PRODUCTS', 'gapi_search_to_products');

define('TABLE_CUSTOMERS_QUOTE', 'customers_quote');
define('TABLE_CUSTOMERS_QUOTE_ATTRIBUTES', 'customers_quote_attributes');
define('TABLE_PLATFORMS_HOLIDAYS', 'platforms_holidays');
...
define('TABLE_OPTIONS_TEMPLATES', 'options_templates');
define('TABLE_OPTIONS_TEMPLATES_ATTRIBUTES', 'options_templates_attributes');
define('TABLE_OPTIONS_TEMPLATES_ATTRIBUTES_PRICES', 'options_templates_attributes_prices');
define('TABLE_PRODUCTS_TO_OPTIONS_TEMPLATES', 'products_to_options_templates');

define('TABLE_SEO_DELIVERY_LOCATION', 'seo_delivery_location');
define('TABLE_SEO_DELIVERY_LOCATION_TEXT', 'seo_delivery_location_text');
define('TABLE_SEO_DELIVERY_LOCATION_TEXT_TEMPLATE' ,'seo_delivery_location_text_template');
define('TABLE_SEO_DELIVERY_LOCATION_PRODUCTS' ,'seo_delivery_location_products');
...
define('TABLE_ORDERS_PRODUCTS_STATUS', 'orders_products_status');
define('TABLE_ORDERS_PRODUCTS_STATUS_HISTORY', 'orders_products_status_history');
define('TABLE_PERSONAL_CATALOG', 'personal_catalog');
...
define('TABLE_PRODUCTS_ASSETS', 'products_assets');
define('TABLE_PRODUCTS_ASSETS_FIELDS', 'products_assets_fields');
define('TABLE_PRODUCTS_ASSETS_VALUES', 'products_assets_values');
...
define('TABLE_GOOGLE_CATEGORIES', 'categories_google_producttype');
