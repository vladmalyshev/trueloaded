...
//          }
        ...
        for ($i=0, $n=sizeof($include_modules); $i<$n; $i++) {
            /*if (file_exists(DIR_FS_CATALOG . DIR_WS_LANGUAGES . '/modules/payment/' . $include_modules[$i]['file'])) {
                include_once(DIR_FS_CATALOG . DIR_WS_LANGUAGES . '/modules/payment/' . $include_modules[$i]['file']);
            }*/
